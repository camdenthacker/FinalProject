 ...
 * Special & Creative Features: This game is a side scroller. Most of my creative features
 * are in the gameplay. For one, this game requires strategic thinking since you have to
 * incorporate the character's ability to reverse gravity. There are certain portions 
 * of the game that you can't get past without using this feature. Also, the coins in
 * the game add extra difficulty, as you sometimes have to backtrack in order to retrieve
 * them. I also added more frames in my character's animation to make it look smoother.
 * Finally, I added particle features to the lava, to make it look more lively.
 * Altogether, the features combine to provide a fun and challenging gameplay experience.
 * PRESS Shift+F5
 * */
angleMode = "radians";
...
var customChar = function() {
    ...
    translate(190,-70);
    rotate(PI/6);
    rect(175,320,40,100,10);//leg 1
    popMatrix();
    
    fill(120, 108, 108);
    rect(160,170,80,150,50);//body
    
    fill(148, 80, 80);
    pushMatrix();
    translate(-130,125);
    rotate(-PI/6);
    rect(175,320,40,100,10);//leg 2
    popMatrix();
    
    pushMatrix();
    translate(-80,130);
    rotate(-PI/6);
    rect(185,190,30,100,10);//arm 1
    popMatrix();
    fill(255, 250, 250);
    ...
    rect(160,170,80,150,50);//body
    fill(148, 80, 80);
    rect(175,300,50,100,10);//leg 1
    rect(175,300,50,100,10);//leg 2 
    rect(185,190,30,100,10);//arm 1
    fill(255, 250, 250);
    ellipse(230,105,20,20);//eye
    ellipse(235,140,20,5);//mouth
    ...
    //Gravity Man Character 2: Left Extra
    noStroke();
    background(255, 255, 255);
    background(255, 255, 255,0);       // set background of the custom char
    fill(120, 108, 108);
    ...
    //Gravity Man Character 3: Left extra
    noStroke();
    background(255, 255, 255);
    background(255, 255, 255,0);       // set background of the custom char
    fill(120, 108, 108);
...
introGManObj.prototype.draw = function() {
    ...
    case 2:
        ...
        break;
    case 3:
        image(images[3], -50, -50, 100, 100);
        break;
    case 4:
        image(images[4], -50, -50, 100, 100);
        break;
    case 5:
        image(images[3], -50, -50, 100, 100);
        break;
...
var displayTilemap = function() {
    ...
    for(var i = 0; i <coins.length; i++){
        if (coins[i].isCollected === 0){
            image(images[10],coins[i].x,coins[i].y,20,20); 
        }
    }
...
GManObj.prototype.draw = function() {
    ...
    case 8:
        ...
        break;
    case 9:
        image(images[6], -50, -100, 100, 100);
        break;
    case 10:
        image(images[7], -50, -100, 100, 100);
        break;
    case 11:
        image(images[8], -50, -100, 100, 100);
        break;
    case 12:
        image(images[9], -50, -100, 100, 100);
        break;
    case 13:
        image(images[8], -50, -100, 100, 100);
        break;
